...
```{r}
# Note: This code assumes that the original data frame 'df' (containing 'time', 'a', 'b', 'c', 'd', 'thrower') 
# and the 'tidy' function (from the 'broom' package) are available in your R environment.
